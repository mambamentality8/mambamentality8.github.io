...
- 条件记录断点
  ...
  ![1566810310768](C:\Users\85896\AppData\Roaming\Typora\typora-user-images\1566810310768.png)
  
  - 来到日志窗口
  
  ![1566810523328](C:\Users\85896\AppData\Roaming\Typora\typora-user-images\1566810523328.png)
  
  - 第一个窗口不是40137D,当点击完这个窗口以后就会断到40137D这个地址
  - 在即将要指向这个地址前被断下来
  
  ![1566810609679](C:\Users\85896\AppData\Roaming\Typora\typora-user-images\1566810609679.png)
  
  - 日志窗口
  
  ![1566810679216](C:\Users\85896\AppData\Roaming\Typora\typora-user-images\1566810679216.png)
...
- 看到B窗口有一个断点
  ...
  ![1566811991651](C:\Users\85896\AppData\Roaming\Typora\typora-user-images\1566811991651.png)

  ![1566812283224](C:\Users\85896\AppData\Roaming\Typora\typora-user-images\1566812283224.png)
  
  - 此时此刻这个函数就是GetDlgItemTextA
  
  ![1566839198115](C:\Users\85896\AppData\Roaming\Typora\typora-user-images\1566839198115.png)
  ...
  ![1566839849269](C:\Users\85896\AppData\Roaming\Typora\typora-user-images\1566839849269.png)
  
  ![1566839782450](C:\Users\85896\AppData\Roaming\Typora\typora-user-images\1566839782450.png)
...
- 消息断点1
  ...
  - 如何设置消息断点呢?
    ...
    ![1566886038396](C:\Users\85896\AppData\Roaming\Typora\typora-user-images\1566886038396.png)

    - 然后打开w窗口
    - 然后右键刷新

    ![1566886558126](C:\Users\85896\AppData\Roaming\Typora\typora-user-images\1566886558126.png)

    - 然后我们找到类型为按钮的内容为OK的这么一个按钮

    ![1566886646898](C:\Users\85896\AppData\Roaming\Typora\typora-user-images\1566886646898.png)

    - 设置一个消息断点,如果不知道是什么类型的事件就选择任意事件类型

    ![1566887075701](C:\Users\85896\AppData\Roaming\Typora\typora-user-images\1566887075701.png)

    - 我这里一抬起鼠标就中断下来,此时断下来的是DialogBoxParamA函数

    ![1566887976657](C:\Users\85896\AppData\Roaming\Typora\typora-user-images\1566887976657.png)

    此时是在系统领空,使用执行到用户代码可以回到用户模块

    ![1566890376144](C:\Users\85896\AppData\Roaming\Typora\typora-user-images\1566890376144.png)

    ![1566890434281](C:\Users\85896\AppData\Roaming\Typora\typora-user-images\1566890434281.png)
...
- 消息断点2
  ...
  - 从系统领空返回到程序领空有两种方法
    ...
    - 1.alt+f9
    - 2.设置内存断点
    - ![1566956287543](C:\Users\85896\AppData\Roaming\Typora\typora-user-images\1566956287543.png)
      - 进入M窗口
    - ![1566956454357](C:\Users\85896\AppData\Roaming\Typora\typora-user-images\1566956454357.png)
      - ![1566956536255](C:\Users\85896\AppData\Roaming\Typora\typora-user-images\1566956536255.png)
    - 这样的话每执行一次都会断下来
  
- 消息断点实际上就是一个条件断点
  
  ![1566915602368](C:\Users\85896\AppData\Roaming\Typora\typora-user-images\1566915602368.png)
  
  ![1566915708534](C:\Users\85896\AppData\Roaming\Typora\typora-user-images\1566915708534.png)
  
  WM_LBUTTONUP可以替换成0x202      因为202事件对应的就是WM_LBUTTONUP
  
  也可以用0x101                                          因为101对应的是WM_KEYUP    相当于给这个按钮添加了一个键盘弹起事件
  
  ![1566916009175](C:\Users\85896\AppData\Roaming\Typora\typora-user-images\1566916009175.png)
  
  将这个事件替换成101,运行程序
  
  ![1566918019291](C:\Users\85896\AppData\Roaming\Typora\typora-user-images\1566918019291.png)
  
  我在这里按下TAB键,也会被断下来
  
  ![1566918374546](C:\Users\85896\AppData\Roaming\Typora\typora-user-images\1566918374546.png)
  
  再次去设置一个消息断点
  
  ![1566918575246](C:\Users\85896\AppData\Roaming\Typora\typora-user-images\1566918575246.png)
  
  在此处去修改条件记录
  
    然后修改条件记录断点
  
    ![1566957272879](C:\Users\85896\AppData\Roaming\Typora\typora-user-images\1566957272879.png)
  
    然后我们运行程序注册序列号,然后跳转到L窗口
  
    ![1566957400684](C:\Users\85896\AppData\Roaming\Typora\typora-user-images\1566957400684.png)
  
    鼠标在OK按钮上的时候会记录你鼠标的轨迹
  
    ![1566957776423](C:\Users\85896\AppData\Roaming\Typora\typora-user-images\1566957776423.png)
...
- 消息断点3
  ...
  ![1566958866611](C:\Users\85896\AppData\Roaming\Typora\typora-user-images\1566958866611.png)

  ESP+8就是这个断点往下移动两行    就是Message = VM_LBUTTONUP

  ![1566961515123](C:\Users\85896\AppData\Roaming\Typora\typora-user-images\1566961515123.png)

  这个意思就是我在OK按钮上操作了什么记录(系统消息 )   把这些记录放在日志文件里面

  然后再次注册,调到L窗口

  ![1566961574789](C:\Users\85896\AppData\Roaming\Typora\typora-user-images\1566961574789.png)